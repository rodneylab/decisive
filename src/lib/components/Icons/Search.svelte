<script lang="ts">
  ...
  export let label: string = 'search icon';
  ...
  // https://api.iconify.design/fa-solid.json?icons=search
</script>

<Icon {id} aria-label={label} {ariaHidden} icon="fa-solid:search" {width} {height} color={colour} />
