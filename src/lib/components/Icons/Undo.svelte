<script lang="ts">
  ...
  export let label: string = 'undo icon';
  ...
  // https://api.iconify.design/fa-solid.json?icons=undo
</script>

<Icon {id} aria-label={label} {ariaHidden} icon="fa-solid:undo" {width} {height} color={colour} />
